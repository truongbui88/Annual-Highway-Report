...
Baruch: Calculate the percentage difference in spending for each of the states in each of the categories. We do a lot of comparison and contrasting in the report. We don't need to know the actual numerical value or percent from the previous year, but knowing how much the value or percent has changed would be very helpful. 
```{r}
